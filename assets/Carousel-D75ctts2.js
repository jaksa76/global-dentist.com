...
`,[c("slides",`
 ...
 `)])])]),io=["transitionDuration","transitionTimingFunction"],lo=Object.assign(Object.assign({},qe.props),{defaultIndex:{type:Number,default:0},currentIndex:Number,showArrow:Boolean,dotType:{type:String,default:"dot"},dotPlacement:{type:String,default:"bottom"},slidesPerView:{type:[Number,String],default:1},spaceBetween:{type:Number,default:0},centeredSlides:Boolean,direction:{type:String,default:"horizontal"},autoplay:Boolean,interval:{type:Number,default:5e3},loop:{type:Boolean,default:!0},effect:{type:String,default:"slide"},showDots:{type:Boolean,default:!0},trigger:{type:String,default:"click"},transitionStyle:{type:Object,default:()=>({transitionDuration:"300ms"})},transitionProps:Object,draggable:Boolean,prevSlideStyle:[Object,String],nextSlideStyle:[Object,String],touchable:{type:Boolean,default:!0},mousewheel:Boolean,keyboard:Boolean,"onUpdate:currentIndex":Function,onUpdateCurrentIndex:Function});let Re=!1;const fo=ce({name:"Carousel",props:lo,setup(e){const{mergedClsPrefixRef:o,inlineThemeDisabled:a}=de(e),l=_(null),f=_(null),p=_([]),P={value:[]},y=x(()=>e.direction==="vertical"),S=x(()=>y.value?"height":"width"),g=x(()=>y.value?"bottom":"right"),v=x(()=>e.effect==="slide"),b=x(()=>e.loop&&e.slidesPerView===1&&v.value),R=x(()=>e.effect==="custom"),M=x(()=>!v.value||e.centeredSlides?1:e.slidesPerView),O=x(()=>R.value?1:e.slidesPerView),C=x(()=>M.value==="auto"||e.slidesPerView==="auto"&&e.centeredSlides),z=_({width:0,height:0}),I=x(()=>{const{value:t}=p;if(!t.length)return[];const{value:n}=C;if(n)return t.map(m=>Ke(m));const{value:r}=O,{value:i}=z,{value:u}=S;let s=i[u];if(r!=="auto"){const{spaceBetween:m}=e,k=s-(r-1)*m,se=1/Math.max(1,r);s=k*se}const h=Object.assign(Object.assign({},i),{[u]:s});return t.map(()=>h)}),$=x(()=>{const{value:t}=I;if(!t.length)return[];const{centeredSlides:n,spaceBetween:r}=e,{value:i}=S,{[i]:u}=z.value;let s=0;return t.map(({[i]:h})=>{let m=s;return n&&(m+=(h-u)/2),s+=h+r,m})}),X=_(!1),fe=x(()=>{const{transitionStyle:t}=e;return t?_e(t,io):{}}),ve=x(()=>R.value?0:Jn(fe.value.transitionDuration)),Ie=x(()=>{const{value:t}=p;if(!t.length)return[];const n=!(C.value||O.value===1),r=h=>{if(n){const{value:m}=S;return{[m]:`${I.value[h][m]}px`}}};if(R.value)return t.map((h,m)=>r(m));const{effect:i,spaceBetween:u}=e,{value:s}=g;return t.reduce((h,m,k)=>{const se=Object.assign(Object.assign({},r(k)),{[`margin-${s}`]:`${u}px`});return h.push(se),X.value&&(i==="fade"||i==="card")&&Object.assign(se,fe.value),h},[])}),D=x(()=>{const{value:t}=M,{length:n}=p.value;if(t!=="auto")return Math.max(n-t,0)+1;{const{value:r}=I,{length:i}=r;if(!i)return n;const{value:u}=$,{value:s}=S,h=z.value[s];let m=r[r.length-1][s],k=i;for(;k>1&&m<h;)k--,m+=u[k]-u[k-1];return le(k+1,1,i)}}),J=x(()=>Gn(D.value,b.value)),vt=Ce(e.defaultIndex,b.value),xe=_(Ye(vt,D.value,b.value)),T=Zt(Wt(e,"currentIndex"),xe),N=x(()=>Ce(T.value,b.value));function Y(t){var n,r;t=le(t,0,D.value-1);const i=Ye(t,D.value,b.value),{value:u}=T;i!==T.value&&(xe.value=i,(n=e["onUpdate:currentIndex"])===null||n===void 0||n.call(e,i,u),(r=e.onUpdateCurrentIndex)===null||r===void 0||r.call(e,i,u))}function q(t=N.value){return Kn(t,D.value,e.loop)}function Q(t=N.value){return Hn(t,D.value,e.loop)}function xt(t){const n=j(t);return n!==null&&q()===n}function ht(t){const n=j(t);return n!==null&&Q()===n}function ke(t){return N.value===j(t)}function pt(t){return T.value===t}function De(){return q()===null}function Ne(){return Q()===null}function he(t){const n=le(Ce(t,b.value),0,D.value);(t!==T.value||n!==N.value)&&Y(n)}function pe(){const t=q();t!==null&&Y(t)}function ee(){const t=Q();t!==null&&Y(t)}let A=!1;function gt(){(!A||!b.value)&&pe()}function mt(){(!A||!b.value)&&ee()}let L=0;const ge=_({});function te(t,n=0){ge.value=Object.assign({},fe.value,{transform:y.value?`translateY(${-t}px)`:`translateX(${-t}px)`,transitionDuration:`${n}ms`})}function F(t=0){v.value?me(N.value,t):L!==0&&(!A&&t>0&&(A=!0),te(L=0,t))}function me(t,n){const r=Ae(t);r!==L&&n>0&&(A=!0),L=Ae(N.value),te(r,n)}function Ae(t){let n;return t>=D.value-1?n=Ee():n=$.value[t]||0,n}function Ee(){if(M.value==="auto"){const{value:t}=S,{[t]:n}=z.value,{value:r}=$,i=r[r.length-1];let u;if(i===void 0)u=n;else{const{value:s}=I;u=i+s[s.length-1][t]}return u-n}else{const{value:t}=$;return t[D.value-1]||0}}const K={currentIndexRef:T,to:he,prev:gt,next:mt,isVertical:()=>y.value,isHorizontal:()=>!y.value,isPrev:xt,isNext:ht,isActive:ke,isPrevDisabled:De,isNextDisabled:Ne,getSlideIndex:j,getSlideStyle:yt,addSlide:bt,removeSlide:wt,onCarouselItemClick:St};qn(K);function bt(t){t&&p.value.push(t)}function wt(t){if(!t)return;const n=j(t);n!==-1&&p.value.splice(n,1)}function j(t){return typeof t=="number"?t:t?p.value.indexOf(t):-1}function yt(t){const n=j(t);if(n!==-1){const r=[Ie.value[n]],i=K.isPrev(n),u=K.isNext(n);return i&&r.push(e.prevSlideStyle||""),u&&r.push(e.nextSlideStyle||""),qt(r)}}let be=0,we=0,V=0,ye=0,ne=!1,Se=!1;function St(t,n){let r=!A&&!ne&&!Se;e.effect==="card"&&r&&!ke(t)&&(he(t),r=!1),r||(n.preventDefault(),n.stopPropagation())}let oe=null;function ae(){oe&&(clearInterval(oe),oe=null)}function U(){ae(),!e.autoplay||J.value<2||(oe=window.setInterval(ee,e.interval))}function Te(t){var n;if(Re||!(!((n=f.value)===null||n===void 0)&&n.contains(Qt(t))))return;Re=!0,ne=!0,Se=!1,ye=Date.now(),ae(),t.type!=="touchstart"&&!t.target.isContentEditable&&t.preventDefault();const r=Fe(t)?t.touches[0]:t;y.value?we=r.clientY:be=r.clientX,e.touchable&&(H("touchmove",document,re),H("touchend",document,B),H("touchcancel",document,B)),e.draggable&&(H("mousemove",document,re),H("mouseup",document,B))}function re(t){const{value:n}=y,{value:r}=S,i=Fe(t)?t.touches[0]:t,u=n?i.clientY-we:i.clientX-be,s=z.value[r];V=le(u,-s,s),t.cancelable&&t.preventDefault(),v.value&&te(L-V,0)}function B(){const{value:t}=N;let n=t;if(!A&&V!==0&&v.value){const r=L-V,i=[...$.value.slice(0,D.value-1),Ee()];let u=null;for(let s=0;s<i.length;s++){const h=Math.abs(i[s]-r);if(u!==null&&u<h)break;u=h,n=s}}if(n===t){const r=Date.now()-ye,{value:i}=S,u=z.value[i];V>u/2||V/r>.4?n=q(t):(V<-u/2||V/r<-.4)&&(n=Q(t))}n!==null&&n!==t?(Se=!0,Y(n),Le(()=>{(!b.value||xe.value!==T.value)&&F(ve.value)})):F(ve.value),$e(),U()}function $e(){ne&&(Re=!1),ne=!1,be=0,we=0,V=0,ye=0,G("touchmove",document,re),G("touchend",document,B),G("touchcancel",document,B),G("mousemove",document,re),G("mouseup",document,B)}function Ct(){if(v.value&&A){const{value:t}=N;me(t,0)}else U();v.value&&(ge.value.transitionDuration="0ms"),A=!1}function Rt(t){if(t.preventDefault(),A)return;let{deltaX:n,deltaY:r}=t;t.shiftKey&&!n&&(n=r);const i=-1,u=1,s=(n||r)>0?u:i;let h=0,m=0;y.value?m=s:h=s;const k=10;(m*r>=k||h*n>=k)&&(s===u&&!Ne()?ee():s===i&&!De()&&pe())}function zt(){z.value=Ke(l.value,!0),U()}function Pt(){var t,n;C.value&&((n=(t=I.effect).scheduler)===null||n===void 0||n.call(t),I.effect.run())}function It(){e.autoplay&&ae()}function kt(){e.autoplay&&U()}Ge(()=>{Xt(U),requestAnimationFrame(()=>X.value=!0)}),Je(()=>{$e(),ae()}),Yt(()=>{const{value:t}=p,{value:n}=P,r=new Map,i=s=>r.has(s)?r.get(s):-1;let u=!1;for(let s=0;s<t.length;s++){const h=n.findIndex(m=>m.el===t[s]);h!==s&&(u=!0),r.set(t[s],h)}u&&t.sort((s,h)=>i(s)-i(h))}),ie(N,(t,n)=>{if(t!==n)if(U(),v.value){if(b.value){const{value:r}=D;J.value>2&&t===r-2&&n===1?t=0:t===1&&n===r-2&&(t=r-1)}me(t,ve.value)}else F()},{immediate:!0}),ie([b,M],()=>void Le(()=>{Y(N.value)})),ie($,()=>{v.value&&F()},{deep:!0}),ie(v,t=>{t?F():(A=!1,te(L=0))});const Dt=x(()=>({onTouchstartPassive:e.touchable?Te:void 0,onMousedown:e.draggable?Te:void 0,onWheel:e.mousewheel?Rt:void 0})),Nt=x(()=>Object.assign(Object.assign({},_e(K,["to","prev","next","isPrevDisabled","isNextDisabled"])),{total:J.value,currentIndex:T.value})),At=x(()=>({total:J.value,currentIndex:T.value,to:K.to})),Et={getCurrentIndex:()=>T.value,to:he,prev:pe,next:ee},Tt=qe("Carousel","-carousel",so,Yn,e,o),Ve=x(()=>{const{common:{cubicBezierEaseInOut:t},self:{dotSize:n,dotColor:r,dotColorActive:i,dotColorFocus:u,dotLineWidth:s,dotLineWidthActive:h,arrowColor:m}}=Tt.value;return{"--n-bezier":t,"--n-dot-color":r,"--n-dot-color-focus":u,"--n-dot-color-active":i,"--n-dot-size":n,"--n-dot-line-width":s,"--n-dot-line-width-active":h,"--n-arrow-color":m}}),Z=a?Ft("carousel",void 0,Ve,e):void 0;return Object.assign(Object.assign({mergedClsPrefix:o,selfElRef:l,slidesElRef:f,slideVNodes:P,duplicatedable:b,userWantsControl:R,autoSlideSize:C,realIndex:N,slideStyles:Ie,translateStyle:ge,slidesControlListeners:Dt,handleTransitionEnd:Ct,handleResize:zt,handleSlideResize:Pt,handleMouseenter:It,handleMouseleave:kt,isActive:pt,arrowSlotProps:Nt,dotSlotProps:At},Et),{cssVars:a?void 0:Ve,themeClass:Z==null?void 0:Z.themeClass,onRender:Z==null?void 0:Z.onRender})},render(){var e;const{mergedClsPrefix:o,showArrow:a,userWantsControl:l,slideStyles:f,dotType:p,dotPlacement:P,slidesControlListeners:y,transitionProps:S={},arrowSlotProps:g,dotSlotProps:v,$slots:{default:b,dots:R,arrow:M}}=this,O=b&&Kt(b())||[];let C=uo(O);return C.length||(C=O.map(z=>w(ro,null,{default:()=>He(z)}))),this.duplicatedable&&(C=Fn(C)),this.slideVNodes.value=C,this.autoSlideSize&&(C=C.map(z=>w(Me,{onResize:this.handleSlideResize},{default:()=>z}))),(e=this.onRender)===null||e===void 0||e.call(this),w("div",Object.assign({ref:"selfElRef",class:[this.themeClass,`${o}-carousel`,this.direction==="vertical"&&`${o}-carousel--vertical`,this.showArrow&&`${o}-carousel--show-arrow`,`${o}-carousel--${P}`,`${o}-carousel--${this.direction}`,`${o}-carousel--${this.effect}`,l&&`${o}-carousel--usercontrol`],style:this.cssVars},y,{onMouseenter:this.handleMouseenter,onMouseleave:this.handleMouseleave}),w(Me,{onResize:this.handleResize},{default:()=>w("div",{ref:"slidesElRef",class:`${o}-carousel__slides`,role:"listbox",style:this.translateStyle,onTransitionend:this.handleTransitionEnd},l?C.map((z,I)=>w("div",{style:f[I],key:I},Ht(w(Jt,Object.assign({},S),{default:()=>z}),[[Gt,this.isActive(I)]]))):C)}),this.showDots&&v.total>1&&Oe(R,v,()=>[w(eo,{key:p+P,total:v.total,currentIndex:v.currentIndex,dotType:p,trigger:this.trigger,keyboard:this.keyboard})]),a&&Oe(M,g,()=>[w(oo,null)]))}});function uo(e){return e.reduce((o,a)=>(ao(a)&&o.push(a),o),[])}export{ro as N,fo as a};
