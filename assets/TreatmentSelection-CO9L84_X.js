import{z as _,G as T,C as n,A as c,D as k,d as A,u as R,a3 as I,H as z,a4 as M,b as V,i as D,o as l,k as d,l as s,_ as G,U as q,x as L,t as $,F as P,Y as Q,q as j,m as g,w as b,p as m,a5 as F,V as v,B as C,a6 as w,n as B,Z as a}from"./index-C9n7Kb-K.js";import{T as O}from"./treatments-FRMeeQws.js";const t="0!important",N="-1px!important";function f(o){return c(`${o}-type`,[n("& +",[_("button",{},[c(`${o}-type`,[k("border",{borderLeftWidth:t}),k("state-border",{left:N})])])])])}function h(o){return c(`${o}-type`,[n("& +",[_("button",[c(`${o}-type`,[k("border",{borderTopWidth:t}),k("state-border",{top:N})])])])])}const W=_("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
