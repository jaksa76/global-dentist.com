import{y as _,E as x,A as n,z as c,C as k,d as A,u as R,Y as I,G as z,b as M,i as G,Z as V,o as l,k as d,l as s,_ as q,R as D,v as L,t as $,F as P,W as Q,q as W,m as g,w as b,p as m,$ as j,S as v,B as C,a0 as w,n as B}from"./index-Bo6RbyAZ.js";import{a}from"./state-DfIyutr0.js";import{T as F}from"./treatments-FRMeeQws.js";const t="0!important",S="-1px!important";function f(o){return c(`${o}-type`,[n("& +",[_("button",{},[c(`${o}-type`,[k("border",{borderLeftWidth:t}),k("state-border",{left:S})])])])])}function p(o){return c(`${o}-type`,[n("& +",[_("button",[c(`${o}-type`,[k("border",{borderTopWidth:t}),k("state-border",{top:S})])])])])}const O=_("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
