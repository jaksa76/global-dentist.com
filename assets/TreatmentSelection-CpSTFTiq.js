import{z as b,G as x,C as s,A as l,D as y,d as S,u as w,a4 as I,H as V,a5 as z,b as D,i as G,_ as q,U as M,x as P,o as d,k as c,l as n,t as $,F as L,$ as Q,q as F,m as h,w as _,p as u,a6 as W,V as T,B as k,a7 as A,n as B,a0 as a}from"./index-ScRd4E-0.js";import{T as j}from"./treatments-FRMeeQws.js";import{C as H}from"./CheckmarkCircleOutline-CGbX3azV.js";const t="0!important",N="-1px!important";function f(o){return l(`${o}-type`,[s("& +",[b("button",{},[l(`${o}-type`,[y("border",{borderLeftWidth:t}),y("state-border",{left:N})])])])])}function m(o){return l(`${o}-type`,[s("& +",[b("button",[l(`${o}-type`,[y("border",{borderTopWidth:t}),y("state-border",{top:N})])])])])}const K=b("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
